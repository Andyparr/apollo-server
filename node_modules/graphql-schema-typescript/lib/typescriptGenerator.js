...
var TypeScriptGenerator = /** @class */ (function () {
    function TypeScriptGenerator(options) {
        this.options = options;
    }
    TypeScriptGenerator.prototype.generate = function (introspectResult) {
    ...
    TypeScriptGenerator.prototype.generateEnumType = function (enumType) {
        ...
        if (this.options.global) {
            return this.createUnionType(enumType.name, enumType.enumValues.map(function (v) { return "'" + v.name + "'"; })).concat([
        ...
        var enumBody = enumType.enumValues.reduce(function (prevTypescriptDefs, enumValue, index) {
            ...
            if (!isLastEnum) {
                typescriptDefs = enumValueJsDoc.concat([enumValue.name + " = '" + enumValue.name + "',"]);
            }
            else {
                typescriptDefs = enumValueJsDoc.concat([enumValue.name + " = '" + enumValue.name + "'"]);
            }
