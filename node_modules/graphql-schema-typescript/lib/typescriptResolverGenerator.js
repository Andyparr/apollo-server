...
var TSResolverGenerator = /** @class */ (function () {
    function TSResolverGenerator(options) {
        var _a;
    ...
    TSResolverGenerator.prototype.generate = function (introspectionResult) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, {
                        ...
                        body: this.resolverObject.concat(this.resolverInterfaces)
                    }];
            });
        });
    };
    ...
    TSResolverGenerator.prototype.generateObjectResolver = function (objectType, isSubscription) {
        ...
        objectType.fields.forEach(function (field) {
            ...
            var returnType = _this.options.asyncResult ? 'TResult | Promise<TResult>' : 'TResult';
            var fieldResolverTypeDef = !isSubscription
                ? [
                    "export interface " + fieldResolverName + "<TParent = " + TParent + ", TResult = " + TResult + "> {",
                    "(parent: TParent, args: " + argsType + ", context: " + _this.contextType + ", info: GraphQLResolveInfo): " + returnType + ";",
                    '}',
                    ''
                ]
                : [
                    ...
                    "resolve" + _this.getModifier() + ": (parent: TParent, args: " + argsType + ", context: " + _this.contextType + ", info: GraphQLResolveInfo) => " + returnType + ";",
                    "subscribe: (parent: TParent, args: " + argsType + ", context: " + _this.contextType + ", info: GraphQLResolveInfo) => " + returnType + ";",
                    '}',
                    ''
                ];
