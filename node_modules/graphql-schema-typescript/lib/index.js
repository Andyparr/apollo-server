...
exports.generateTSTypesAsString = function (schema, options) { return __awaiter(_this, void 0, void 0, function () {
    var mergedOptions, introspectResult, tsGenerator, typeDefs, typeResolvers, tsResolverGenerator, header, body, formatted;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                mergedOptions = __assign({}, types_1.defaultOptions, options);
                if (!util_1.isString(schema)) return [3 /*break*/, 2];
                return [4 /*yield*/, utils_1.introspectSchemaViaLocalFile(path.resolve(schema))];
            case 1:
                introspectResult = _a.sent();
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, utils_1.introspectSchema(schema)];
            case 3:
                introspectResult = _a.sent();
                _a.label = 4;
            case 4:
                tsGenerator = new typescriptGenerator_1.TypeScriptGenerator(mergedOptions);
                return [4 /*yield*/, tsGenerator.generate(introspectResult)];
            case 5:
                typeDefs = _a.sent();
                typeResolvers = {
                    body: [],
                ...
                tsResolverGenerator = new typescriptResolverGenerator_1.TSResolverGenerator(mergedOptions);
                return [4 /*yield*/, tsResolverGenerator.generate(introspectResult)];
            case 6:
