...
exports.introspectSchema = function (schema) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, graphql_1.graphql({ schema: schema, source: graphql_1.introspectionQuery })];
            case 1:
...
function introspect(schemaContents) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            schema = graphql_1.buildASTSchema(graphql_1.parse(schemaContents));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, introspect(allTypeDefs)];
...
exports.gqlScalarToTS = function (scalarName, typePrefix) {
    switch (scalarName) {
        case 'Int':
        case 'Float':
            return 'number';
...
exports.getTypeToTS = function (field, prefix, nonNullable) {
    if (nonNullable === void 0) { nonNullable = false; }
    var tsType = '';
    if (field.kind === 'NON_NULL') {
        return exports.getTypeToTS(field.ofType, prefix, true);
    }
    if (field.kind === 'LIST') {
        tsType = exports.getTypeToTS(field.ofType, prefix, false);
        tsType = "Array<" + tsType + ">";
    }
    else {
        tsType = exports.gqlScalarToTS(field.name, prefix);
    }
    if (!nonNullable) {
        tsType = tsType + " | null";
    }
...
exports.createFieldRef = function (field, prefix, strict) {
    ...
    if (!strict && nullable) {
        ...
        fieldType = exports.getTypeToTS(field.type, prefix, true);
    }
    else {
        fieldName = "" + field.name;
        fieldType = exports.getTypeToTS(field.type, prefix, false);
    }
