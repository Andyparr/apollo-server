...
export declare function introspect(schemaContents: string): Promise<IntrospectionQuery>;
...
export declare const gqlScalarToTS: (scalarName: string, typePrefix: string) => string;
export declare const getTypeToTS: (field: any, prefix: string, nonNullable?: boolean) => string;
